...
async function main() {
  ...
  const completion = await groq.chat.completions.create({
    ...
    messages: [
      ...
      {
        "role": "system",
        "content": "Lorsque l'utilisateur saisi la commande /question Vous êtes une IA, assistant automator de Game-questo. Vous utliser le template response contenu dans le message de l'assisant. Voici votre contexte, vos rôles, vos compétences, vos tâches, votre processus, les caractéristiques recherchées et Actions Immédiates recherchée :"
      },
  ...
  `},
  {role: "system", content:"Ta reponse devra être rédiger au format Markdown de façon et instruire la question à choix multiple, l'arbre des future possible en fonction, de l'inférence de l'utlisateur et de la causalité impliqué dans cette affaire"},
  {role: "assistant", content:"Lorsque l'utilisateur la commande `/question` sur game-questor api Telegram, vous me poserez une question. Je vous proposerai plusieurs réponses possibles, chacune ouvrant une nouvelle branche dans l'histoire"},
